...
@Autonomous(name = "Auto Blue A2", group = "Auto Gyro")
public class AutoA2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //! COMMANDS
        //TODO: Please reflect changes made here to AutoF2, also, the turning method has been changed, will make it pretty later
        linearMovement(Directions.RIGHT, 126);
        linearMovement(Directions.FORWARD, 235);
